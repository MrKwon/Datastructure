...
public class TreeExceptions {
    ...
    public static class NotInternalNodeException extends RuntimeException {
        public NotInternalNodeException(String err) { super(err); }
    }

    public static class NotExternalNodeException extends RuntimeException {
        public NotExternalNodeException(String err) { super(err); }
    }
}

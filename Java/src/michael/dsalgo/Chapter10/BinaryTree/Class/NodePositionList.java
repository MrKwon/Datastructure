...
import michael.dsalgo.Chapter10.Exceptions.LinkedListExceptions.*;
...
public class NodePositionList<E> implements PositionList<E> {
    ...
    @Override
    public Position<E> first() throws EmptyLinkedListException {
        if (isEmpty()) throw new EmptyLinkedListException("List is empty");
        return this.first.getNext();
    }

    @Override
    public Position<E> last() throws EmptyLinkedListException {
        if (isEmpty()) throw new EmptyLinkedListException("List is empty");
